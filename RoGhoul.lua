game:GetService("StarterGui"):SetCore("SendNotification", {Title = "Created By FunTrat0r#0020", Text = "STILL NOT A RIP"})
...
fs.Name = "rg"
fs.Parent = rg
fs.BackgroundColor3 = Color3.new(0.0784314, 0, 0)
...
buttonf.BorderColor3 = Color3.new(0.333333, 0, 0.00392157)
...
farmbutton.BorderColor3 = Color3.new(0.333333, 0, 0.00392157)
...
questbutton.BorderColor3 = Color3.new(0.333333, 0, 0.00392157)
questbutton.Position = UDim2.new(0.54285717, 0, 0.142857149, 0)
...
speedbutton.BorderColor3 = Color3.new(0.333333, 0, 0.00392157)
...
Mobsbutton.BorderColor3 = Color3.new(0.333333, 0, 0.00392157)
Mobsbutton.Position = UDim2.new(0.54285717, 0, 0.589999974, 0)
...
default.BorderColor3 = Color3.new(0.333333, 0, 0.00392157)
...
user.TextColor3 = Color3.new(1, 0, 0.0156863)
user.TextSize = 10
...
TextLabel.Text = "LETS SHED SOME BLOOD"
...
TextLabel_2.Text = "Geneva Ayala#0666"
TextLabel_2.TextColor3 = Color3.new(0.0392157, 1, 0.521569)
TextLabel_2.TextSize = 10

farmf.Name = "farmf"
farmf.Parent = fs
farmf.BackgroundColor3 = Color3.new(0.0784314, 0, 0)
farmf.BorderColor3 = Color3.new(0.333333, 0, 0.00392157)
...
superspeed.BorderColor3 = Color3.new(0.333333, 0, 0.00392157)
...
speed.BorderColor3 = Color3.new(0.333333, 0, 0.00392157)
...
q.BorderColor3 = Color3.new(0.333333, 0, 0.00392157)
...
questf.BorderColor3 = Color3.new(0.333333, 0, 0.00392157)
...
repfarm.BorderColor3 = Color3.new(0.333333, 0, 0.00392157)
...
quesfarm.BorderColor3 = Color3.new(0.333333, 0, 0.00392157)
...
mobf.BorderColor3 = Color3.new(0.333333, 0, 0.00392157)
...
HUMAN.BorderColor3 = Color3.new(0.333333, 0, 0.00392157)
...
lowag.BorderColor3 = Color3.new(0.333333, 0, 0.00392157)
...
boss.BorderColor3 = Color3.new(0.333333, 0, 0.00392157)
...
highaog.BorderColor3 = Color3.new(0.333333, 0, 0.00392157)
...
AUTOATTACK.BorderColor3 = Color3.new(0.333333, 0, 0.00392157)
...
farmoff.MouseButton1Down:connect(function()
	farmoff.Text = "FUCK YOU! NOT SUPPORTED"
	wait(2)
	farmoff.Text = "AUTO FARM ALL : OFF"
end)
...
local pfs = game:GetService("PathfindingService")
			...
			if k.Name == "Low Rank Aogiri Member" then -- Mid And High
local path = pfs:FindPathAsync(lp.Character.HumanoidRootPart.Position, k:FindFirstChild("HumanoidRootPart").Position)
local points = path:GetWaypoints()
...
warn("Always Wait 5-10 Seconeds After Killing A Mob It Will Auto Move To Next One")