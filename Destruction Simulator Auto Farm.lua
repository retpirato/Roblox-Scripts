...
TextLabel.Text = "| Auto => Farm, Sell | by reav"
...
while wait() do 
	if ok then
		...
		for i,v in pairs(workspace.Clickable.First:GetChildren()) do 
			if v.ClassName == "Model" and v:FindFirstChild("Part") then
				game:GetService("ReplicatedStorage").Resources.RemoteEvents.Click:FireServer(workspace[player.Name]:FindFirstChildWhichIsA("Tool"), v.Part)
			end
		end
		for i,v in pairs(workspace.Clickable.Second:GetChildren()) do 
			if v.ClassName == "Model" and v:FindFirstChild("Part") then
				game:GetService("ReplicatedStorage").Resources.RemoteEvents.Click:FireServer(workspace[player.Name]:FindFirstChildWhichIsA("Tool"), v.Part)
			end
		end
		for i,v in pairs(workspace.Clickable.Third:GetChildren()) do 
			if v.ClassName == "Model" and v:FindFirstChild("Part") then
				game:GetService("ReplicatedStorage").Resources.RemoteEvents.Click:FireServer(workspace[player.Name]:FindFirstChildWhichIsA("Tool"), v.Part)
			end
		end
		for i,v in pairs(workspace.Clickable.Fourth:GetChildren()) do 
			if v.ClassName == "Model" and v:FindFirstChild("Part") then
				game:GetService("ReplicatedStorage").Resources.RemoteEvents.Click:FireServer(workspace[player.Name]:FindFirstChildWhichIsA("Tool"), v.Part)
			end
		end
		for i,v in pairs(workspace.Clickable.Fith:GetChildren()) do 
			if v.ClassName == "Model" and v:FindFirstChild("Part") then
				game:GetService("ReplicatedStorage").Resources.RemoteEvents.Click:FireServer(workspace[player.Name]:FindFirstChildWhichIsA("Tool"), v.Part)
			end
		end
		for i,v in pairs(workspace.Clickable.Sixth:GetChildren()) do 
			if v.ClassName == "Model" and v:FindFirstChild("Part") then
				game:GetService("ReplicatedStorage").Resources.RemoteEvents.Click:FireServer(workspace[player.Name]:FindFirstChildWhichIsA("Tool"), v.Part)
			end
		end
		for i,v in pairs(workspace.Clickable.Seventh:GetChildren()) do 
			if v.ClassName == "Model" and v:FindFirstChild("Part") then
				game:GetService("ReplicatedStorage").Resources.RemoteEvents.Click:FireServer(workspace[player.Name]:FindFirstChildWhichIsA("Tool"), v.Part)
			end
		end
		for i,v in pairs(workspace.Clickable.Eighth:GetChildren()) do 
			if v.ClassName == "Model" and v:FindFirstChild("Part") then
				game:GetService("ReplicatedStorage").Resources.RemoteEvents.Click:FireServer(workspace[player.Name]:FindFirstChildWhichIsA("Tool"), v.Part)
			end
		end
		for i,v in pairs(workspace.Clickable.Ninth:GetChildren()) do 
			if v.ClassName == "Model" and v:FindFirstChild("Part") then
				game:GetService("ReplicatedStorage").Resources.RemoteEvents.Click:FireServer(workspace[player.Name]:FindFirstChildWhichIsA("Tool"), v.Part)
			end
		end
		for i,v in pairs(workspace.Clickable.Tenth:GetChildren()) do 
			if v.ClassName == "Model" and v:FindFirstChild("Part") then
				game:GetService("ReplicatedStorage").Resources.RemoteEvents.Click:FireServer(workspace[player.Name]:FindFirstChildWhichIsA("Tool"), v.Part)
			end
		end
