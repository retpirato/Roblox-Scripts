    ...
    if type(v) == "function" then
        for k,x in next, getupvalues(v) do
            if type(x) == "table" then
                for l,n in next, x do
                    if l == "loadgrenade" and "loadgun" then
                        Client.char = x
                    elseif l == "breakwindows" then
                        Client.effects = x
                    elseif l == "add" then
                        Client.network = x
                    end
...
if Client then
    ...
    local function PlayerData()
        ...
        function BreakWindex()--llol
            ...
            --[[
                [TO DO LIST]
                {completely rewrite the funcs hook}
                to fix spot all and fake inf credits lol
            ]]
        ...
        function CreateUI()
            ...
            InfJumpBTN.Position = UDim2.new(0.358620673, 0, 0.279999971, 0)
            ...
            breakWindowsBTN.Position = UDim2.new(0.67126435, 0, 0.279999971, 0)
            ...
            InFagsBTN.Position = UDim2.new(0.673563182, 0, 0.144615382, 0)
            InFagsBTN.Size = UDim2.new(0, 104, 0, 28)
            InFagsBTN.Font = Enum.Font.SourceSans
            InFagsBTN.Text = "Inf Frags(broken)"
            InFagsBTN.TextColor3 = Color3.new(1, 1, 1)
            InFagsBTN.TextSize = 17
            
            Frame_6.Parent = InFagsBTN
            ...
            NoSwayBTN.Position = UDim2.new(0.358620703, 0, 0.406153858, 0)
            ...
            FullAutoBTN.Position = UDim2.new(0.668965578, 0, 0.406153888, 0)
            ...
            InstaReloadBTN.Position = UDim2.new(0.358620733, 0, 0.532307744, 0)
            ...
            Frame_11.Parent = InstaReloadBTN
            ...
            RapidFireBTN.Position = UDim2.new(0.668965578, 0, 0.538461566, 0)
            ...
            GunModBTN.Position = UDim2.new(0.059770178, 0, 0.65538466, 0)
            ...
            FireRateTXT.Name = "FireRateTXT"
            FireRateTXT.Parent = MainFrame
            FireRateTXT.BackgroundColor3 = Color3.new(0.137255, 0.137255, 0.137255)
            FireRateTXT.BorderSizePixel = 0
            FireRateTXT.Position = UDim2.new(0.668965638, 0, 0.6553846, 0)
            FireRateTXT.Size = UDim2.new(0, 104, 0, 28)
            FireRateTXT.Font = Enum.Font.SourceSans
            FireRateTXT.Text = "Value"
            FireRateTXT.TextColor3 = Color3.new(1, 1, 1)
            FireRateTXT.TextSize = 14
            
            Frame_14.Parent = FireRateTXT
            ...
            FireRateBTN.Name = "FireRateBTN"
            FireRateBTN.Parent = MainFrame
            FireRateBTN.BackgroundColor3 = Color3.new(0.137255, 0.137255, 0.137255)
            FireRateBTN.BackgroundTransparency = 0.5
            FireRateBTN.BorderSizePixel = 0
            FireRateBTN.Position = UDim2.new(0.356321901, 0, 0.65538466, 0)
            FireRateBTN.Size = UDim2.new(0, 104, 0, 28)
            FireRateBTN.Font = Enum.Font.SourceSans
            FireRateBTN.Text = "Fire Rate"
            FireRateBTN.TextColor3 = Color3.new(1, 1, 1)
            FireRateBTN.TextSize = 20
            
            Frame_15.Parent = FireRateBTN
            ...
            LabelRate.Parent = MainFrame
            LabelRate.BackgroundColor3 = Color3.new(1, 1, 1)
            LabelRate.BackgroundTransparency = 1
            LabelRate.Position = UDim2.new(0.673563063, 0, 0.741538465, 0)
            LabelRate.Size = UDim2.new(0, 104, 0, 16)
            LabelRate.Font = Enum.Font.SourceSans
            LabelRate.Text = "Fire Rate Value"
            LabelRate.TextColor3 = Color3.new(1, 1, 1)
            LabelRate.TextSize = 14                              
