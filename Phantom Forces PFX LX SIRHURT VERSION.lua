--[[
     so when is icepools gonna add debug.getupvalue lmao
]]
	...
	if type(v) == "function" then 
		for k,x in next, debug.getupvalues(v) do 
			if type(x) == "table" then 
				if rawget(x, "gammo") then 
					Client.gamelogic = x
				elseif rawget(x, "add") then
					Client.network = x
					Client.funcs = getupvalues(x.add, 0)
				elseif rawget(x,"breakwindows") then
					Client.effects = x
				elseif rawget(x,"loadgun") and rawget(x,"loadgrenade") then
					Client.char = x
				end
				if network and gamelogic and effects and char then
					break
...
local Version = 'v.1.7.b'
local Updated = '8/10/2019'
...
if Client then
    ...
    local function PlayerData()
        ...
        function CreateUI()
            ...
            local InFagsBTN = Instance.new("TextButton")
            local Frame_7 = Instance.new("Frame")
            local InfCredsBTN = Instance.new("TextButton")
            ...
            MainFrame.Position = UDim2.new(0.172046751, 0, 0.304610968, 0)
            ...
            SpotAllBTN.Parent = MainFrame
            SpotAllBTN.BackgroundColor3 = Color3.new(0.137255, 0.137255, 0.137255)
            SpotAllBTN.BackgroundTransparency = 0.5
            SpotAllBTN.BorderSizePixel = 0
            SpotAllBTN.Position = UDim2.new(0.365517199, 0, 0.280000001, 0)
            SpotAllBTN.Size = UDim2.new(0, 104, 0, 28)
            SpotAllBTN.Font = Enum.Font.SourceSans
            SpotAllBTN.Text = "Spot All"
            SpotAllBTN.TextColor3 = Color3.new(1, 1, 1)
            SpotAllBTN.TextSize = 20
            
            Frame_2.Parent = SpotAllBTN
            ...
            NoClipBTN.Position = UDim2.new(0.363218397, 0, 0.409230828, 0)
            ...
            InfJumpBTN.Position = UDim2.new(0.0620689653, 0, 0.41230765, 0)
            ...
            breakWindowsBTN.Position = UDim2.new(0.685057461, 0, 0.279999971, 0)
            ...
            Frame_5.Parent = breakWindowsBTN
            ...
            InFagsBTN.Name = "InFagsBTN"
            InFagsBTN.Parent = MainFrame
            InFagsBTN.BackgroundColor3 = Color3.new(0.137255, 0.137255, 0.137255)
            InFagsBTN.BackgroundTransparency = 0.5
            InFagsBTN.BorderSizePixel = 0
            InFagsBTN.Position = UDim2.new(0.685057461, 0, 0.144615382, 0)
            InFagsBTN.Size = UDim2.new(0, 104, 0, 28)
            InFagsBTN.Font = Enum.Font.SourceSans
            InFagsBTN.Text = "Inf Frags"
            InFagsBTN.TextColor3 = Color3.new(1, 1, 1)
            InFagsBTN.TextSize = 20
            
            Frame_7.Parent = InFagsBTN
            ...
            InfCredsBTN.Name = "InfCredsBTN"
            InfCredsBTN.Parent = MainFrame
            InfCredsBTN.BackgroundColor3 = Color3.new(0.137255, 0.137255, 0.137255)
            InfCredsBTN.BackgroundTransparency = 0.5
            InfCredsBTN.BorderSizePixel = 0
            InfCredsBTN.Position = UDim2.new(0.365517259, 0, 0.144615382, 0)
            InfCredsBTN.Size = UDim2.new(0, 104, 0, 28)
            InfCredsBTN.Font = Enum.Font.SourceSans
            InfCredsBTN.Text = "Inf Creds"
            InfCredsBTN.TextColor3 = Color3.new(1, 1, 1)
            InfCredsBTN.TextSize = 20
            
            Frame_8.Parent = InfCredsBTN
            ...
            NoRecoilBTN.Position = UDim2.new(0.685057461, 0, 0.403076977, 0)
            ...
            NoFlashBTN.Position = UDim2.new(0.0620689988, 0, 0.538461566, 0)
            ...
            NoSwayBTN.Position = UDim2.new(0.360919565, 0, 0.538461566, 0)
            ...
            FullAutoBTN.Position = UDim2.new(0.685057521, 0, 0.538461566, 0)
            ...
            InstaReloadBTN.Position = UDim2.new(0.0597701669, 0, 0.65538466, 0)
            ...
            Frame_13.Parent = InstaReloadBTN
            Frame_13.BackgroundColor3 = Color3.new(0.0941177, 0.0941177, 0.0941177)
            Frame_13.BorderSizePixel = 0
            Frame_13.Position = UDim2.new(0, 0, 0.928571701, 0)
            Frame_13.Size = UDim2.new(0, 104, 0, 2)
            ...
            RapidFireBTN.Position = UDim2.new(0.360919595, 0, 0.65538466, 0)
            ...
            Frame_14.Parent = RapidFireBTN
            Frame_14.BackgroundColor3 = Color3.new(0.0941177, 0.0941177, 0.0941177)
            Frame_14.BorderSizePixel = 0
            Frame_14.Position = UDim2.new(0, 0, 0.928571701, 0)
            Frame_14.Size = UDim2.new(0, 104, 0, 2)
            ...
            GunModBTN.Position = UDim2.new(0.682758689, 0, 0.65538466, 0)
            GunModBTN.Size = UDim2.new(0, 104, 0, 28)
            GunModBTN.Font = Enum.Font.SourceSans
            GunModBTN.Text = "All Gun Mods"
            GunModBTN.TextColor3 = Color3.new(1, 1, 1)
            GunModBTN.TextSize = 20
            
            Frame_15.Parent = GunModBTN
            Frame_15.BackgroundColor3 = Color3.new(0.0941177, 0.0941177, 0.0941177)
            Frame_15.BorderSizePixel = 0
            Frame_15.Position = UDim2.new(0, 0, 0.928571701, 0)
            Frame_15.Size = UDim2.new(0, 104, 0, 2)
            ...
            Recommended.Parent = MainFrame
            Recommended.BackgroundColor3 = Color3.new(1, 1, 1)
            Recommended.BackgroundTransparency = 1
            Recommended.Position = UDim2.new(0.68505764, 0, 0.735384643, 0)
            Recommended.Size = UDim2.new(0, 103, 0, 16)
            Recommended.Font = Enum.Font.SourceSans
            Recommended.Text = "Recommended"
            Recommended.TextColor3 = Color3.new(1, 1, 1)
            Recommended.TextSize = 14   
            
            UpdateInfo.Text = 'Last Updated : '..tostring(Updated)
            DiscordInfo.Text = 'Discord : '..DiscordLink

            if client and Funcs then
                Status.Text = 'Functionality Status : '..GoodStat
            end

            if Funcs and not client then
                Status.Text = 'Functionality Status : '..MainFrameFail
            end

            if client and not Funcs then
                Status.Text = 'Functionality Status : '..HookFuncFail
            end

            if not client and not Funcs then
